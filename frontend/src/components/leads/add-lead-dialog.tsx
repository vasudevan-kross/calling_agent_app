...
export function AddLeadDialog({ onClose }: AddLeadDialogProps) {
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
            ...
            <Button
              type="submit"
              disabled={createLead.isPending}
              className="flex-1 h-12 text-base font-medium bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg shadow-blue-500/25"
            >
